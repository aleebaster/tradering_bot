...
async function main() {
  ...
  const checks = {
    ...
    activeAllocation: long.includes("🎯 TP1: 72600.00") && long.includes("Закрити: 50%") && long.includes("🎯 TP2: 73100.00") && long.includes("Закрити: 50%") && long.includes("🎯 TP3: 73800.00") && long.includes("Runner: 0%"),
