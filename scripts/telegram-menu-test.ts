...
async function main() {
  ...
  await notifier.send(["🚨 SIGNAL: SHORT", "", "📍 Pair:", "BTCUSDT", "", "🎯 Entry:", "104250-104400", "", "🛡 Stop Loss:", "104900", "", "💰 Take Profit:", "TP1 103800 / TP2 103100 / TP3 102400", "", "⚡ Leverage:", "x3", "", "📈 Confidence:", "97%", "", "📊 Reason:", "RSI momentum aligned; MACD confirms direction; SMA trend aligned."].join("\n"), signalActions);
