...
const signalActions: TelegramReplyMarkup = {
  inline_keyboard: [
    ...
    [{ text: "📈 Детальний аналіз", callback_data: "analyze_futures:BTCUSDT" }, { text: "❌ Видалити", callback_data: "remove:BTCUSDT" }]
  ]
};
...
async function main() {
  ...
  await notifier.send(["🚀 BTCUSDT — ENTER NOW", "", "📍 Entry: 104250 - 104400", "🛑 SL: 104900", "", "🎯 TP1: 103800", "🎯 TP2: 103100", "🎯 TP3: 102400", "", "⚡ x3", "🔥 Confidence: 97%", "📊 RR: 1:4.2", "", "Причина:", "✅ momentum confirm", "✅ OI confirm", "✅ sniper trigger"].join("\n"), signalActions);
  console.log(JSON.stringify({
    ...
    proof: {
      ...
      buttons: ["📊 Сигнали", "🔍 Аналіз пари", "🔥 Найкращі сигнали", "🔍 Пошук по парах", "👀 Watchlist", "➕ Додати пару", "📄 Мій список", "❌ Видалити пару", "🔴 Моніторинг", "📈 Ринок", "🔄 Оновити Ринок", "₿ BTC Фільтр", "🧪 Діагностика", "⚙️ Налаштування", "💰 Баланс", "⚡ Плече", "x2", "x3", "🔔 Сповіщення", "🎯 Risk mode", "Conservative", "Balanced", "Aggressive", "🟢 Моніторити", "🔄 Оновити Аналіз", "❌ Видалити", "📈 Детальний аналіз"]
    }
  }, null, 2));
}
