...
async function main() {
  ...
  const checks = {
    ...
    activeAllocation: long.includes("🎯 TP1: 72600.00") && long.includes("Закрити: 40%") && long.includes("🎯 TP2: 73100.00") && long.includes("Закрити: 30%") && long.includes("🎯 TP3: 73800.00") && long.includes("Runner: 20%"),
    activeRisk: long.includes("Кількість: ~") && long.includes("⚙️ Margin: ISOLATED 2x") && long.includes("🛡 Breakeven: Move to") && long.includes("+fees protected") && long.includes("Activation: Do not move on first TP1 wick") && long.includes("Anti-shakeout:") && long.includes("TP2 protection:") && long.includes("Anti-giveback:") && long.includes("Risk mode: safe") && long.includes("📦 Розмір позиції:") && long.includes("⚠️ Ризик: ~") && long.includes("ROI"),
